...
public interface SimplyStarminerItems {
    ...
    Item CREATIVE_STAR_CORE_ITEM       = register(new Identifier(MODID, "creative_star_core"),            new BlockItem(CREATIVE_STAR_CORE, new QuiltItemSettings().group(STARMINER_GROUP)));
