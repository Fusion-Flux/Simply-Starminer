...
public class SimplyStarMiner implements ModInitializer {
	...
	public void onInitialize(ModContainer mod) {
		STAR_CORE_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(SimplyStarMiner.MOD_ID, "redstone_randomizer_entity"), FabricBlockEntityTypeBuilder.create(StarCoreEntity::new, STAR_CORE).build(null));
		Registry.register(Registry.BLOCK, new Identifier(SimplyStarMiner.MOD_ID, "star_core"), STAR_CORE);
		Registry.register(Registry.ITEM, new Identifier(SimplyStarMiner.MOD_ID, "star_core"), new BlockItem(STAR_CORE, new QuiltItemSettings().group(StarminerGroup)));

		Registry.register(Registry.BLOCK, new Identifier(SimplyStarMiner.MOD_ID, "gravity_plate"), GRAVITY_PLATE);
		Registry.register(Registry.ITEM, new Identifier(SimplyStarMiner.MOD_ID, "gravity_plate"), new BlockItem(GRAVITY_PLATE, new QuiltItemSettings().group(StarminerGroup)));

		Registry.register(Registry.ITEM, new Identifier(SimplyStarMiner.MOD_ID, "gravity_anchor_down"), GRAVITY_ANCHOR_DOWN);
		Registry.register(Registry.ITEM, new Identifier(SimplyStarMiner.MOD_ID, "gravity_anchor_up"), GRAVITY_ANCHOR_UP);
		Registry.register(Registry.ITEM, new Identifier(SimplyStarMiner.MOD_ID, "gravity_anchor_north"), GRAVITY_ANCHOR_NORTH);
		Registry.register(Registry.ITEM, new Identifier(SimplyStarMiner.MOD_ID, "gravity_anchor_south"), GRAVITY_ANCHOR_SOUTH);
		Registry.register(Registry.ITEM, new Identifier(SimplyStarMiner.MOD_ID, "gravity_anchor_west"), GRAVITY_ANCHOR_WEST);
		Registry.register(Registry.ITEM, new Identifier(SimplyStarMiner.MOD_ID, "gravity_anchor_east"), GRAVITY_ANCHOR_EAST);
